...
const targetStr = `                    <div class="tarjeta-stats" style="display: flex; flex-direction: column; gap: 0;">
                        ...
                        <!-- STOCK POTENCIAL: Marginal, tamaño miniatura, reverso secuencial -->
                        <div class="stat-item" style="text-align: right; padding-top: 4px; margin-top: 6px; border-top: 1px dashed #cbd5e1;">
                            <span style="font-size: 0.70rem; color: #94a3b8; font-weight: 600;">Potencial: </span>
