...
const newLogic = `// [TICKET #028] Unificación de Payload para Devoluciones (Evitar fraccionamiento)
            ...
            const urlLomasoft = \`\${baseUrl}/api/devoluciones/candidatas\`; // Asumimos endpoint unificado equivalente a facturas
