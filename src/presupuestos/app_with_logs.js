...
console.log('[PRESUPUESTOS-BACK] 🚀 Iniciando servidor del módulo de presupuestos CON LOGS...');
...
// Importar rutas CON LOGS DE DEPURACIÓN
const presupuestosRoutes = require('./routes/presupuestos_with_logs');
...
console.log('[PRESUPUESTOS-BACK] ✅ Rutas API CON LOGS montadas en /api/presupuestos');
...
app.get('/health', (req, res) => {
    ...
    res.json({
        success: true,
        service: 'presupuestos-server-with-logs',
        status: 'running',
        port: PORT,
        timestamp: new Date().toISOString(),
        uptime: process.uptime(),
        memory: process.memoryUsage(),
        version: '1.1.0-with-logs',
        features: {
...
const server = app.listen(PORT, () => {
    ...
    console.log('[PRESUPUESTOS-BACK] 🎉 SERVIDOR CON LOGS INICIADO EXITOSAMENTE');
    console.log('[PRESUPUESTOS-BACK] 🎉 ================================');
    ...
    console.log('[PRESUPUESTOS-BACK] 🔍 LOGS DE DEPURACIÓN ACTIVADOS');
