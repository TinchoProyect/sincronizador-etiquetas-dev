...
console.log('[PRESUPUESTOS-BACK] Configurando rutas del módulo CON LOGS DE DEPURACIÓN...');
...
router.get('/', validatePermissions('presupuestos.read'), sanitizarDatos, validarFiltros, async (req, res) => {
    console.log('[PRESUPUESTOS-BACK] Ruta GET / - Obteniendo todos los presupuestos');
    try {
...
router.get('/estadisticas', validatePermissions('presupuestos.read'), async (req, res) => {
    console.log('[PRESUPUESTOS-BACK] Ruta GET /estadisticas - Calculando estadísticas');
...
router.post('/sync/ejecutar', validatePermissions('presupuestos.sync'), async (req, res) => {
    console.log('[PRESUPUESTOS-BACK] 🚀 Ruta POST /sync/ejecutar - EJECUTANDO SINCRONIZACIÓN CON LOGS');
...
console.log('[PRESUPUESTOS-BACK] ✅ Rutas CON LOGS DE DEPURACIÓN configuradas exitosamente');
console.log('[PRESUPUESTOS-BACK] 📋 Rutas de consulta disponibles:');
console.log('[PRESUPUESTOS-BACK]    - GET /api/presupuestos (con filtros avanzados)');
...
console.log('[PRESUPUESTOS-BACK]    - GET /api/presupuestos/estadisticas');
